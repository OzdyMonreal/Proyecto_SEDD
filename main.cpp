...
int main() {
  ...
  while (true)
  {
      ...
      cout << "12) Menu de Aldeanos" << endl;
      cout << "13) Respaldar Civilizaciones y Aldeanos" << endl;
      cout << "14) Recuperar Civilizaciones y Aldeanos" << endl;
      cout << "15) Salir" << endl;
      getline(cin, op);
      cout << endl;
    ...
    if (op == "1") {
      ...
      juego.respaldarCivilizacion();
      cout << "Se han respaldado correctamente..." << endl;
    }
    else if (op == "14") {
      juego.recuperarCivilizacion();
      cout << "Se han recuperado correctamente..." << endl;
    }
